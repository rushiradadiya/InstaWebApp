...
const Login = props => {
    ...
    const renderSignUpView = () => {
        return (<div className="mainContainer">
                <h1>Demo</h1>
                <div>
                    <h2 className='h2'>Sign up to see photos and videos from your friends.</h2>
                ...
                <span className="spanContainer">
                    Log in with Facebook
                        ...
                        <div style={{marginTop: 5, marginLeft: 30, marginBottom: "6%", marginRight: 30}}>
                            ...
                            <TextField name="password" type="password" value={password} placeholder={'Password'} onChange={
                                (password) =>
